...
export default function Home() {
    ...
    const openPrint = () => window.dispatchEvent(new Event("open-print-modal"));
    ...
    return (
        <PublicLayout>
            ...
            <div className="w-full py-4 md:py-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                {/* --- COMPACT GRID LAYOUT --- */}
                {/* Grid forces the left and right halves to sit tightly together */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-2 w-full max-w-6xl mx-auto items-center">
                    {/* ================= LEFT COLUMN: Text + Bento Cards ================= */}
                    {/* ml-auto and mr-0 pushes the left column as far right as possible to close the gap */}
                    <div className="flex flex-col gap-8 w-full max-w-200 mx-auto lg:ml-auto lg:mr-0 px-4 lg:px-0">
                        ...
                        <div className="text-center lg:text-left flex flex-col items-center lg:items-start">
                            ...
                            <p className="mt-4 text-stone-500 font-medium text-sm md:text-base leading-relaxed">
                                Welcome back to the Gerona Municipal Library.
                                Your next great story or service is just a click
                                away.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                            ...
                            {/* row-span-2 ensures it takes up the entire left side and matches the height of the two smaller cards stacked together */}
                            <Link
                            ...
                            >
                                <div className="relative z-10">
                                    ...
                                    <p className="text-stone-500 text-[11px] md:text-xs max-w-[10rem] leading-relaxed">
                                        Search our physical books and digital
                                        modules.
                                    </p>
                                </div>
                                ...
                                <Icon
                                    ...
                                    className="absolute -right-4 -bottom-4 w-32 h-32 opacity-10 group-hover:scale-110 transition-transform pointer-events-none"
                                />
                            </Link>

                            {/* SECONDARY ACTION 1: PRINT STATION (Top Right) */}
                            <button
                                onClick={openPrint}
                                className="w-full h-full bg-white p-4 md:p-5 rounded-[1.5rem] border-2 border-pink-100 shadow-sm hover:shadow-md shadow-pink-200/20 group text-left flex flex-col items-start gap-3 hover:border-emerald-200 transition-all hover:-translate-y-1"
                            >
                                <div className="w-10 h-10 bg-emerald-50 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform border border-emerald-100">
                                    <Icon
                                ...
                                <div>
                                    <h3 className="text-sm font-black text-slate-800 group-hover:text-emerald-600 transition-colors leading-tight">
                                        Print Station
                                    </h3>
                            ...
                            {/* SECONDARY ACTION 2: REGISTER CARD (Bottom Right) */}
                            <button
                            ...
                            >
                                ...
                                <div>
                                    <h3 className="text-sm font-black text-slate-800 group-hover:text-amber-600 transition-colors leading-tight">
                                        Get a Card
                                    </h3>
                                    <p className="text-stone-400 text-[9px] mt-0.5">
                    ...
                    {/* justify-start pulls the carousel tightly towards the left text */}
