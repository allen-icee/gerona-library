...
export default function AddPatronModal() {
    ...
    const submitNewPatron: FormEventHandler = (e) => {
        ...
        post(route("patrons.store"), {
            ...
            onError: (err) => {
                toast.error("Failed to register patron. Please check the form.");
            }
        });
    };
            ...
            <DialogContent className="sm:max-w-[700px] bg-white rounded-2xl border-fuchsia-100 shadow-xl shadow-stone-200/50 max-h-[90vh] overflow-y-auto custom-scrollbar">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-xs text-slate-500 font-medium">
                        Add a new borrower. The system will auto-generate their Library Card Number.
                    </DialogDescription>
                </DialogHeader>

                <form onSubmit={submitNewPatron} onKeyDown={handleFormKeyDown} className="space-y-5 py-2">

                    {/* NAMES */}
                    <div className="grid grid-cols-12 gap-4">
                        <div className="col-span-12 sm:col-span-4 space-y-1.5">
                            <Label htmlFor="first_name" className="text-xs font-bold uppercase text-slate-600">First Name *</Label>
                            <Input
                                id="first_name"
                        ...
                        <div className="col-span-6 sm:col-span-2 space-y-1.5">
                            <Label htmlFor="middle_initial" className="text-xs font-bold uppercase text-slate-600 text-center block">M.I.</Label>
                            <Input
                                id="middle_initial"
                                maxLength={2}
                        ...
                        <div className="col-span-12 sm:col-span-4 space-y-1.5">
                            <Label htmlFor="last_name" className="text-xs font-bold uppercase text-slate-600">Last Name *</Label>
                            <Input
                                id="last_name"
                    ...
                    {data.type === "Student" && (
                        <div className="space-y-1.5 animate-in fade-in slide-in-from-top-2 duration-300">
                            <Label htmlFor="school" className="text-xs font-bold uppercase text-slate-600">School *</Label>
                            <Input
                                id="school"
                                value={data.school}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1.5">
                            <Label htmlFor="contact_number" className="text-xs font-bold uppercase text-slate-600">Contact #</Label>
                            <Input
                                id="contact_number"
                                maxLength={11}
                    ...
                    <div className="space-y-1.5">
                        <Label htmlFor="street" className="text-xs font-bold uppercase text-slate-600">Street / House No. (Optional)</Label>
                        <Input
                            id="street"
                            value={data.street}
