//resources\js\Pages\Admin\Circulation\Index.tsx
            ...
            <div className="max-w-full space-y-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-4 rounded-2xl border border-rose-100 shadow-sm shadow-rose-100/50">
                    <div className="flex items-center gap-3">
                        <div className="bg-linear-to-br from-rose-300 to-rose-500 w-12 h-12 rounded-xl flex items-center justify-center shadow-md shadow-rose-200 text-white">
                    ...
                    <a
                        ...
                        className="inline-flex items-center justify-center px-4 h-9.5 text-xs font-bold transition-all bg-rose-50 text-rose-600 hover:bg-rose-500 hover:text-white rounded-lg border border-rose-200 shadow-sm group w-full sm:w-auto"
                    >
