            ...
            <div className="max-w-full space-y-6">
                ...
                <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 bg-white p-4 rounded-2xl border border-emerald-100 shadow-sm shadow-emerald-100/50">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="bg-linear-to-br from-emerald-400 to-emerald-600 w-12 h-12 rounded-xl flex items-center justify-center shadow-md shadow-emerald-300/50 text-white shrink-0">
                    ...
                    <div className="flex flex-wrap items-center gap-2 w-full xl:w-auto">
                        ...
                        <Link
                            ...
                            className="inline-flex items-center justify-center px-4 h-10 text-xs font-bold transition-all bg-linear-to-r from-emerald-400 to-emerald-600 hover:from-emerald-500 hover:to-emerald-700 text-white rounded-xl shadow-md shadow-emerald-200 border-none flex-1 sm:flex-none w-full sm:w-auto mt-2 sm:mt-0"
                        >
