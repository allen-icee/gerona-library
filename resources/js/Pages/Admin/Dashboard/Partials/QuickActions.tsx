    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                >
                    <div className="bg-blue-50 p-3.5 rounded-xl group-hover:bg-gradient-to-br group-hover:from-blue-400 group-hover:to-blue-600 group-hover:text-white transition-all mb-3 text-blue-500 shadow-sm">
                ...
                >
                    <div className="bg-rose-50 p-3.5 rounded-xl group-hover:bg-gradient-to-br group-hover:from-rose-400 group-hover:to-rose-600 group-hover:text-white transition-all mb-3 text-rose-500 shadow-sm">
                ...
                >
                    <div className="bg-fuchsia-50 p-3.5 rounded-xl group-hover:bg-gradient-to-br group-hover:from-fuchsia-400 group-hover:to-fuchsia-600 group-hover:text-white transition-all mb-3 text-fuchsia-500 shadow-sm">
