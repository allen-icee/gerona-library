...
export default function DevCreditModal({
    ...
    const coInterns = [
        {
            name: "Christian Jay C. Caones",
            link: "https://www.facebook.com/cjaywho",
        },
        {
            name: "Ronjean F. David",
            link: "https://www.facebook.com/ronjean.david",
        },
        {
            name: "Elijah Miguel V. Inocencio",
            link: "https://www.facebook.com/EllyMigzz",
        },
        {
            name: "Luke Reed Chard R. Mendoza",
            link: "https://www.facebook.com/profile.php?id=61572692654781",
        },
        {
            name: "Dean Mark Rei A. Villanueva",
            link: "https://www.facebook.com/zygote.REI",
        },
    ];
            ...
            >
                ...
                >
                    ...
                    <DialogDescription className="sr-only">
                        Information about the project team and MIS interns
                        behind the system.
                    </DialogDescription>
                        ...
                        <img
                            ...
                            onError={(e) => {
                                (e.target as HTMLImageElement).src =
                                    "https://placehold.co/800x350/ffe4e6/f43f5e?text=Insert+Team+Photo+Here";
                            }}
                        />
                    ...
                    <DialogHeader className="mb-2 mt-2">
                        ...
                        <p className="text-sm md:text-base text-stone-500 font-medium text-center px-4">
                            Working together to make the library a welcoming
                            place for everyone.
                        </p>
                    </DialogHeader>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <p className="text-[10px] md:text-xs uppercase tracking-widest font-bold mb-0.5 opacity-70 group-hover:text-white">
                                        Lead Developer
                                    </p>
                    ...
                    >
                        ...
                        >
                            <img
                                ...
                                onError={(e) => {
                                    (e.target as HTMLImageElement).src =
                                        "https://placehold.co/1200x800/1e293b/f43f5e?text=Insert+Team+Photo+Here";
                                }}
                            />
