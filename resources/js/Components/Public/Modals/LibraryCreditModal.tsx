        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="font-['Arial',sans-serif] bg-gradient-to-br from-[#d4af37] via-[#fdf5d3] to-[#c7a445] border-[6px] border-pink-300 rounded-xl sm:max-w-[750px] max-h-[90svh] p-0 shadow-2xl overflow-hidden flex justify-center [&>button]:absolute [&>button]:right-4 [&>button]:top-4 [&>button]:bg-white [&>button]:text-rose-500 [&>button]:p-2 [&>button]:rounded-full [&>button]:shadow-lg hover:[&>button]:bg-rose-50 hover:[&>button]:scale-110 [&>button]:transition-all [&>button]:border [&>button]:border-rose-200 [&>button]:z-[100] [&>button>svg]:w-5 [&>button>svg]:h-5">
                <DialogDescription className="sr-only">
                    Dedication and credits for the Dr. Jorge Cleofas Bocobo
                    Library.
                </DialogDescription>
                            ...
                            <div className="text-[8pt] md:text-[10pt] text-center space-y-3 leading-[1.2] font-normal px-1 md:px-1 mb-1">
                                <p>
                                    ...
                                    <span className="font-black">
                                        Dr. Jorge Cleofas Bocobo
                                    </span>
                                    , a distinguished son of Gerona, Tarlac,
                                    whose life and work greatly enriched the
                                    nation's legal, academic, and literary
                                    heritage. As one of the principal authors of
                                    the Philippine Civil Code and the translator
                                    of Noli Me Tangere and El Filibusterismo, he
                                    helped make the ideals of justice, freedom,
                                    and nationalism accessible to generations of
                                    Filipinos.
                                </p>
                                <p>
                                    Dr. Bocobo served with distinction at the
                                    University of the Philippines College of
                                    Law, where he rose from instructor to
                                    professor and later became Acting Dean in
                                    1917. His unwavering commitment to public
                                    service, education, and intellectual
                                    excellence stands as an enduring inspiration
                                    to the people of Gerona and the Filipino
                                    nation.
                                </p>
                                <p>
                                    This Library is also dedicated to all
                                    Geronians—past, present, and future—whose
                                    love for learning, culture, and community
                                    continues to shape the town's shared
                                    identity and hopes for progress.
                                </p>
                            </div>
                            ...
                            <div className="w-full pt-4 px-2">
                                ...
                                <div className="space-y-3 mb-1">
                                    <div>
                                        ...
                                        <p className="text-[8pt] md:text-[9pt] tracking-[0.2em] font-normal">
                                            Municipal Mayor
                                        </p>
                                    </div>
                                    <div>
                                        ...
                                        <p className="text-[8pt] md:text-[9pt] tracking-[0.2em] font-bold">
                                            Vice Mayor
                                        </p>
                                    </div>
                                </div>
