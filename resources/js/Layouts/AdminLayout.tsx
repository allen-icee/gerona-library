...
// Find your lucide-react imports and add Gift
import {
    LayoutDashboard,
    BookOpen,
    Users,
            ...
            <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col fixed inset-y-0 z-10">
                ...
                <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                    ...
                    <Link
                        ...
                        className={`flex items-center px-4 py-3 rounded-lg transition-colors ${isActive("/patrons") ? "bg-amber-600 text-white shadow-md" : "hover:bg-slate-800 hover:text-white"}`}
                    >
                    ...
                    <Link
                        ...
                        className={`flex items-center px-4 py-3 rounded-lg transition-colors ${isActive("/circulation") ? "bg-amber-600 text-white shadow-md" : "hover:bg-slate-800 hover:text-white"}`}
                    >
                    ...
                    <Link
                        ...
                        className={`flex items-center px-4 py-3 rounded-lg transition-colors ${isActive("/print-services") ? "bg-amber-600 text-white shadow-md" : "hover:bg-slate-800 hover:text-white"}`}
                    >
                    ...
                    <Link
                        ...
                        className={`flex items-center px-4 py-3 rounded-lg transition-colors ${isActive("/donations") ? "bg-amber-600 text-white shadow-md" : "hover:bg-slate-800 hover:text-white"}`}
                    >
                    ...
                    <div className="flex items-center gap-4">
                        <div className="text-right hidden sm:block">
                            ...
                            <p className="text-xs text-amber-600 font-medium">
                                {/* Safe check for roles array to prevent crashes */}
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger className="focus:outline-none">
                                <div className="w-10 h-10 rounded-full bg-slate-900 text-white flex items-center justify-center font-bold shadow-sm hover:bg-slate-800 transition-colors cursor-pointer">
                                    {user.name.charAt(0)}
                                </div>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent
                                align="end"
                                className="w-56 mt-1 bg-white"
                            >
                                <DropdownMenuLabel>
                                    My Account
                                </DropdownMenuLabel>
                                ...
                                <DropdownMenuItem asChild>
                                    <Link
                                        ...
                                        method="post"
                                        as="button"
                                        className="w-full cursor-pointer text-red-600 focus:text-red-700 focus:bg-red-50"
                                    >
