            ...
            <div className="max-w-[100rem] mx-auto w-full flex flex-col flex-1 relative z-10 px-4 md:px-8">
                ...
                <div className="relative w-full">
                    ...
                    <div
                        ...
                        className="flex flex-row space-x-1.5 md:space-x-2 items-end z-20 overflow-x-auto no-scrollbar pr-4 pt-12 md:pt-16 pl-[6.5rem] sm:pl-[7.5rem] md:pl-[9.5rem] lg:pl-[10rem] snap-x [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
                    >
                        <Link
                            href="/"
                            className={`flex items-center gap-1.5 px-4 md:px-6 py-2.5 md:py-3.5 rounded-t-xl md:rounded-t-2xl border-2 border-b-0 relative translate-y-[2px] transition-all duration-300 min-w-max snap-start ${isHome
                                ? "bg-linear-to-b from-rose-400 to-rose-500 text-white border-rose-200 z-20 pb-4 md:pb-5 shadow-[0_-4px_12px_rgba(244,114,182,0.4)]"
                        ...
                        <Link
                            ...
                            className={`flex items-center gap-1.5 px-4 md:px-6 py-2.5 md:py-3.5 rounded-t-xl md:rounded-t-2xl border-2 border-b-0 relative translate-y-[2px] transition-all duration-300 min-w-max snap-start ${isCatalog
                                ? "bg-linear-to-b from-pink-400 to-pink-500 text-white border-pink-200 z-20 pb-4 md:pb-5 shadow-[0_-4px_12px_rgba(244,114,182,0.4)]"
                        ...
                        <Link
                            ...
                            className={`flex items-center gap-1.5 px-3 md:px-5 py-2 md:py-3 rounded-t-lg md:rounded-t-xl border-2 border-b-0 relative translate-y-[2px] transition-all duration-300 min-w-max snap-start ${isPrint
                                ? "bg-linear-to-b from-fuchsia-400 to-fuchsia-500 text-white border-fuchsia-200 z-20 pb-4 md:pb-5 shadow-[0_-4px_12px_rgba(217,70,239,0.4)]"
                        ...
                        <Link
                            ...
                            className={`flex items-center gap-1.5 px-3 md:px-5 py-2 md:py-3 rounded-t-lg md:rounded-t-xl border-2 border-b-0 relative translate-y-[2px] transition-all duration-300 min-w-max snap-start ${isRegister
                                ? "bg-linear-to-b from-amber-400 to-amber-500 text-white border-amber-200 z-20 pb-4 md:pb-5 shadow-[0_-4px_12px_rgba(251,191,36,0.4)]"
                    ...
                    <div
                        className={`absolute right-[-1rem] bottom-0 top-[3rem] w-20 bg-linear-to-l from-[#FFF0F5] via-[#FFF0F5]/90 to-transparent flex items-end pb-3 justify-end pr-5 pointer-events-none transition-opacity duration-300 md:hidden z-30 ${showScrollIndicator ? 'opacity-100' : 'opacity-0'}`}
                    >
                        <Icon icon="solar:round-alt-arrow-right-bold-duotone" className="w-6 h-6 text-pink-500 animate-pulse drop-shadow-sm" />
                    </div>
